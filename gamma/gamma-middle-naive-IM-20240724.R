...
pdf("/Users/ehector/Dropbox/Projects/IMfusion/paper/figures/simple-gamma-opt-ind.pdf", height=5, width=5)
...
theta.dag <- seq(0,2,0.05)
middle_IM <- pl.mid(theta=theta_vec, theta.dag=theta.dag, theta_MLE=theta_MLE, k=k, J_ni=J_ni, n_i, M=10000)

pdf("/Users/ehector/Dropbox/Projects/IMfusion/paper/figures_meta/gamma-valid-meta-inference.pdf", height=5, width=5)
conf_level <- 0.8
